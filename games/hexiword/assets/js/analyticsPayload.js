...
// game_action event_payload is the payload hash. See analytics.md.
...
(function (global) {
   ...
   * @returns {string} payload hash for game_action event_payload
   */
   ...
   * @param {string|object} payload JSON string or plain object
   * @param {function(string,string,string)=} onUpdate
   * @param {function(string,string)=} onAction (context, hash)
   */
  function gameAction(context, payload, onUpdate, onAction) {
    var hash = syncPayload(payload, onUpdate);
